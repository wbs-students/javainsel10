  ...
  public static void main( String[] args ) throws Exception
  {
    ...
    for ( float quality = 1f; quality >= 0; quality -= 0.25 )
    {
      ...
      System.out.printf( "Qualität: %.1f - Größe: %,.0f k - Verhältnis: %.2f%n",
                         quality, (double) out.size() / 1024, (double) out.size() / size );
    }
  }

  private static void writeImage( BufferedImage img, ByteArrayOutputStream out, float quality ) throws IOException
  {
